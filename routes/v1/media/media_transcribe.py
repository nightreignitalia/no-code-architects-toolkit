...
def transcribe(job_id, data):
    ...
    try:
        result = process_transcribe_media(media_url, task, include_text, include_srt, include_segments, word_timestamps, response_type, language, initial_prompt, job_id, words_per_line)
